...
The static site contains **222 material identities, 92 named states, 1,593
observations, 10 registered properties and references to 28 source documents**. It has no
...
- `1045`, `4140`, `8620H`, `D2`, `H13`, or `steel density`.
