...
The website ships the published library files without modifications. Its
worker and model construction code live one directory above this file.
...
of the three downloaded archives. No package manager runs on the public site.
