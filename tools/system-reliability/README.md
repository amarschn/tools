...
Combine a list of component MTBF values into a system reliability at a chosen mission time, plus the equivalent system MTBF. The tool uses a constant failure rate (exponential) model and supports parallel redundancy within each component block.

This tool takes component MTBFs as inputs. To estimate an MTBF from test or field failure data, use the [MTBF Calculator](../mtbf/).
