...
- 126 Python tests pass with no skips. Full structural and semantic validation of the factual catalog and synthetic
...
- 134 factual material identities, 24 genuine named states, 840 observations,
  10 registered properties, and 5 source documents. One registered property
  currently has no observations; missing data is displayed as unreported.
- Readable search index approximately 161 KB raw / 14 KB gzip. Warm Node query
  p95 is approximately 3 ms on the development machine. This measurement is a
...
- Search routing, conversion, significant figures, bounds, intervals,
  uncertainty conversion, and compiler/browser parity across all 134 records.
...
- Saved PDF hashes checked for all five documents. The full import reconstructs
