...
python3 scripts/inject_seo_meta.py     # idempotently backfills <head> meta/canonical/OG + analytics into tool pages, and refreshes the homepage's static tool links
```
