...
- [ ] Convert legacy tools to the standard template (`beam-bending`, `simple_thermal`, `door-spring-app`, `fits`, `system-reliability`, `trajectory`). (`wire-sizing` converted 2026-07-13.)
